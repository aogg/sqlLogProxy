 ...
 */
class MysqlClientConnectionLocalConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDatabaseConnection(): void
    {
        ...
        try {
            // 执行简单的查询
            $result = Db::connection('backend_mysql')->select('SELECT 1 as test');
    ...
    public function test_db_DatabaseConnection(): void
    {
        echo "\n========== 开始测试数据库连接 ==========\n";

        try {
            // 执行简单的查询
            $result = Db::connection('backend_mysql')->select('SELECT * from db');
            // $result = Db::select('SELECT 1 as test');
